...
from .views import DistributorView, DistributorDetailView, DistributorReceiptsView, DistributorDemandView, AcceptHandler, RejectHandler, AcceptedOrders
urlpatterns = [
    ...
    path("accepted/", AcceptedOrders.as_view(), name="accepted_orders"),
